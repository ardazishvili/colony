...
void ModelLoader::load() {
  ...
  auto tankFactoryModel = std::make_unique<Model>();
  ...
  auto hqModel = std::make_unique<Model>();
  ...
  auto tfTexture = std::make_shared<Texture>(GL_TEXTURE_2D, 
		  		"/home/roman/repos/opengl/assets/Garage.png");
  tfTexture->load();
  _menuTextures.emplace(MenuTextures::TankFactory, std::move(tfTexture));

  auto hqTexture = std::make_shared<Texture>(GL_TEXTURE_2D, 
		  		"/home/roman/repos/opengl/assets/Hq.png");
  hqTexture->load();
  _menuTextures.emplace(MenuTextures::Hq, std::move(hqTexture));
  auto lightTankTexture = std::make_shared<Texture>(GL_TEXTURE_2D, 
		  		"/home/roman/repos/opengl/assets/lightTank.png");
  lightTankTexture->load();
  _menuTextures.emplace(MenuTextures::TankLight, std::move(lightTankTexture));
  auto mediumTankTexture = std::make_shared<Texture>(GL_TEXTURE_2D, 
		  		"/home/roman/repos/opengl/assets/mediumTank.png");
  mediumTankTexture->load();
  _menuTextures.emplace(MenuTextures::TankMedium, std::move(mediumTankTexture));
  auto heavyTankTexture = std::make_shared<Texture>(GL_TEXTURE_2D, 
		  		"/home/roman/repos/opengl/assets/heavyTank.png");
