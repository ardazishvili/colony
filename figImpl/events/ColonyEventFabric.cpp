...
std::unique_ptr<Event> ColonyEventFabric::getKeyPressEvent(int key,
                                                           int scancode,
                                                           int mods)
{
...
std::unique_ptr<Event> ColonyEventFabric::getKeyReleaseEvent(int key,
                                                             int scancode,
                                                             int mods)
{
...
std::unique_ptr<Event> ColonyEventFabric::getKeyRepeatEvent(int key,
                                                            int scancode,
                                                            int mods)
{
...
std::unique_ptr<Event> ColonyEventFabric::getMouseScrollEvent(double xoffset,
                                                              double yoffset)
{
  return std::make_unique<ColonyMouseScrollEvent>(xoffset, yoffset);
}

std::unique_ptr<Event> ColonyEventFabric::getMouseMoveEvent(double xpos,
                                                            double ypos)
{
  return std::make_unique<ColonyMouseMoveEvent>(xpos, ypos);
}

std::unique_ptr<Event> ColonyEventFabric::getMousePressedEvent(int button,
                                                               int action,
                                                               int mods)
{
...
std::unique_ptr<Event> ColonyEventFabric::getMouseReleasedEvent(int button,
                                                                int action,
                                                                int mods)
{
