...
int main(int argc, char** argv)
{
  ...
  /* /1* float screenHeight = mode->height - 150; *1/ */
  ...
  /* /1* glPolygonMode(GL_FRONT_AND_BACK, GL_LINE); *1/ */
  ...
  /*                        256 * 2, */
  /*                        zScale); */
  /* std::unique_ptr<Game> game = std::make_unique<Game>(window, view,
   * projection); */
  ...
  /*     glm::radians(camera.fov()), screenWidth / screenHeight, 0.01f,
   * 1000.0f); */
  ...
  /*   /1* auto s = Sphere(colorShader, glm::vec3(0.0f, 0.0f, 5.0f), 1.0f, 50);
   * *1/ */
  /*   /1* s.render(); *1/ */
